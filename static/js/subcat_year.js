...
document.addEventListener('DOMContentLoaded', function() {
    console.log("subcat_year.js loaded");

    const submenu52 = document.getElementById("submenu52");

    submenu52.addEventListener('click', function(event) {
        event.preventDefault();
        console.log("submenu52 clicked");
        handleMenuClick52();
    });
});
