...
function showgraph() {
    ...
    // Load and plot revenue and expense data for the year 2019 on page load
    document.addEventListener('DOMContentLoaded', function() {
    ...
    Plotly.newPlot("YOURGRAPHHERE", traces, layout);
}
