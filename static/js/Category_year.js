...
document.addEventListener('DOMContentLoaded', function() {
    console.log("Category_year.js loaded");
    const submenu51 = document.getElementById("submenu51");

    submenu51.addEventListener('click', function(event) {
        event.preventDefault();
        console.log("submenu51 clicked");
        handleMenuClick51();
    });
});
...
function handleMenuClick51() {
    console.log("handleMenuClick51 function called");
    // Hide the Menu
...
function fetchChartData51() {
    ...
    let apiUrl;
    if (menuType === "Expense") {
        apiUrl = `http://127.0.0.1:5000/api/v1.0/merged_df_ak_final_exp/${year}`;
    } else if (menuType === "Revenue") {
        apiUrl = `http://127.0.0.1:5000/api/v1.0/merged_df_ak_final_rev/${year}`;
    }
